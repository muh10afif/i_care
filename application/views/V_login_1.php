    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(./template/assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-wrapper d-flex no-block justify-content-center align-items-center">
                <div class="logo">
                    <span class="db mb-2" style="position: fixed; margin-top: -410px; margin-left: 64px;"><img src="<?= base_url() ?>template/img/logo.png" width="33%" alt="logo" /></span>   
                </div>
            </div>
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                        ...
                        <h1 class="mb-2"><b style="color:#122E5D; font-size: 30px; font-weight: bold; text-shadow: 1px 1px 1px #000;">I - Care</b></h1>
                    </div>
                    <!-- Form -->
                    <div class="row">
                        <div class="col-12">
