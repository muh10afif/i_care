...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 align-self-center">
            <h4 class="page-title">Laporan Biaya Per PIC</h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Laporan</li>
                        <li class="breadcrumb-item"><a href="<?= base_url('') ?>">Laporan Biaya Per PIC</a></li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="card border-info shadow">
                ...
                <form action="<?= base_url('laporan/export_data_pic') ?>" method="POST" target="_self" id="aksi_export">
        ...
        <div class="col-md-9">
            <div class="card shadow">
                ...
                <div class="card-body table-responsive">
                    <table class="table table-bordered table-hover" id="tbl_biaya_pic" width="100%">
...
$(document).ready(function () {
    ...
    var tbl_biaya_pic = $('#tbl_biaya_pic').DataTable({
        "processing"    : true,
        "ajax"          : {
            "url"   : "<?=base_url("laporan/tampil_biaya_p_pic")?>",
            "type"  : "POST",
            "data"  : function (data) {
    ...
    var tbl_resume = $('#tbl_resume').DataTable({
        ...
        "dom"           : "t",
        "ajax"          : {
            "url"   : "<?=base_url("laporan/tampil_resume_pic")?>",
            "type"  : "POST",
            "data"  : function (data) {
                data.bulan_awal       = $('#start').val();
                data.bulan_akhir      = $('#end').val();
    ...
    $('#filter').click(function () {
        tbl_biaya_pic.ajax.reload(null, false);        
    ...
    $('#reset').click(function () {
        ...
        tbl_biaya_pic.ajax.reload(null, false);
        tbl_biaya_pic.clear().draw();
        tbl_biaya_pic.search("").draw();
