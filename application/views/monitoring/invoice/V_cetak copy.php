...
<p style="margin-top: 0pt; margin-bottom: 0pt; text-align: justify; line-height: 108%; font-size: 11pt;"><span style="font-family: Calibri;">Tanggal</span><span style="width: 29.24pt; display: inline-block;">&nbsp;</span><span style="font-family: Calibri;">:</span><span style="font-family: Calibri;">&nbsp;&nbsp; </span><span style="font-family: Calibri;"><?php echo date('d F Y', strtotime($tglinvoice));?></span></p>
...
<?php 
    ...
    $total_debitur      = 0; $no=1; 
    $total_rec          = 0;
    $total_pendapatan   = 0;

    foreach ($cabang as $r) : 

    $total_debitur      += $r['tot_deb'];
...
<p style="margin-top: 0pt; margin-bottom: 0pt; text-align: right; font-size: 10pt;"><span style="font-family: Calibri;"><?php echo number_format($r['recoveries'] + $r['tot_recov_awal'],2);?></span></p>
</td>
<td style="border-style: solid; border-width: 0.75pt; padding-right: 5.03pt; padding-left: 5.03pt; background-color: #ffffff;">
<p style="margin-top: 0pt; margin-bottom: 0pt; text-align: right; font-size: 10pt;"><span style="font-family: Calibri;"><?php echo number_format(($r['recoveries'] + $r['tot_recov_awal'])*0.15,2);?></span></p>
</td>
...
<tr>
	...
	<td style="border-style: solid; border-width: 0.75pt; padding-right: 5.03pt; padding-left: 5.03pt; background-color: #FFFFFF">
        <p style="margin-top: 0pt; margin-bottom: 0pt; text-align: right; font-size: 10pt;"><span style="font-family: Calibri;">

        <?php $dpp = $total_pendapatan / 1.1; echo number_format($dpp ,2);?></span></p>
	</td>
	<td style="width: 105.05pt; border-top-style: solid; border-top-width: 0.75pt; border-left-style: solid; border-left-width: 0.75pt; border-bottom-style: solid; border-bottom-width: 0.75pt; padding-right:5.03pt; padding-left: 5.03pt; vertical-align: top; background-color: #FFFFFF;">
		<p style="margin-top: 0pt; margin-bottom: 0pt; font-size: 10pt;"><span style="font-family: Calibri;">&nbsp;</span></p>
	</td>
...
<tr>
	...
	<td style="border-style: solid; border-width: 0.75pt; padding-right: 5.03pt; padding-left: 5.03pt; background-color: #FFFFFF">
        <p style="margin-top: 0pt; margin-bottom: 0pt; text-align: right; font-size: 10pt;"><span style="font-family: Calibri;">
        <?php $ppn = $dpp * 0.10; echo number_format($ppn,2); ?></span></p>
	</td>
	<td style="width: 105.05pt; border-top-style: solid; border-top-width: 0.75pt; border-left-style: solid; border-left-width: 0.75pt; border-bottom-style: solid; border-bottom-width: 0.75pt; padding-right:5.03pt; padding-left: 5.03pt; vertical-align: top; background-color: #FFFFFF;">
		<p style="margin-top: 0pt; margin-bottom: 0pt; font-size: 10pt;"><span style="font-family: Calibri;">&nbsp;</span></p>
	</td>
...
<tr>
	...
	<td style="border-style: solid; border-width: 0.75pt; padding-right: 5.03pt; padding-left: 5.03pt; background-color: #FFFFFF">
        <p style="margin-top: 0pt; margin-bottom: 0pt; text-align: right; font-size: 10pt;"><span style="font-family: Calibri;">
        <?php $pph23 = $dpp * 0.02;  echo number_format($pph23,2); ?></span></p>
	</td>
	<td style="width: 105.05pt; border-top-style: solid; border-top-width: 0.75pt; border-left-style: solid; border-left-width: 0.75pt; border-bottom-style: solid; border-bottom-width: 0.75pt; padding-right:5.03pt; padding-left: 5.03pt; vertical-align: top; background-color: #FFFFFF;">
		<p style="margin-top: 0pt; margin-bottom: 0pt; font-size: 10pt;"><span style="font-family: Calibri;">&nbsp;</span></p>
	</td>
