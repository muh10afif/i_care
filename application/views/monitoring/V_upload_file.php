        ...
        <div class="col-12 align-self-center">
            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= base_url() ?>">I-Care</a></li>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card shadow">
				...
				<form method="POST" action="<?= base_url('monitoring/do_upload') ?>" enctype="multipart/form-data" autocomplete="off">
					<div class="card-body">
						<div class="row">
							<div class="col-md-4">
							...
							<?php $no=1; foreach ($data_upload as $d): ?>
								<tr>
									...
									<td align="center">
										<div class="row">
											<div class="col-md-6">
												<form action="<?= base_url() ?>monitoring/download" method="POST">
													<input type="hidden" name="dok" value="<?= $d['dokumen'] ?>">
													<button class="btn btn-success" type="submit" >Download</button>
												</form>
											</div>
											<div class="col-md-6">
												<form action="<?= base_url('monitoring/hapus_file_dok') ?>" method="POST">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#submit').submit(function(e){
			e.preventDefault();
				$.ajax({
					url 		: '<?= base_url('monitoring/do_upload') ?>',
					type 		: "post",
